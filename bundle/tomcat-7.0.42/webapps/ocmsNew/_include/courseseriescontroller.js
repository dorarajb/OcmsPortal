...
courseseriesControllers.controller('courseSeriesDetailsCtrl', ['$scope', '$http', '$window', '$filter','$modalInstance', 'item', 'Courseseries', 
											function ($scope, $http, $window, $filter, $modalInstance, item, Courseseries) {
		...
		$scope.updateCourseSeriesEventStartDate = function(courseSeries) {			
			...
			courseSeries.startDate = $filter('date')( courseSeries.startDate, "yyyy-MM-dd");
			//courseSeries.endDate.setDate(courseSeries.endDate.getDate()+ numberOfDaysToAdd);
			//courseSeries.endDate = $filter('date')( courseSeries.endDate, "yyyy-MM-dd");
...
courseseriesControllers.controller('createcourseseriesCtrl', ['$scope', '$http', '$window','$modal','$location', 'Course', 'Location', 'Courseseries','$timeout',
		  function($scope, $http, $modal, $window, $location, Course, Location, Courseseries, $timeout) {	
