...
import com.ocms.course.NoSuchLocationException;
import com.ocms.course.model.Location;
import com.ocms.course.model.impl.LocationImpl;
import com.ocms.course.model.impl.LocationModelImpl;
...
public class LocationPersistenceImpl extends BasePersistenceImpl<Location>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_LOCATIONID =
		new FinderPath(LocationModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			LocationModelImpl.LOCATIONID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_LOCATIONID = new FinderPath(LocationModelImpl.ENTITY_CACHE_ENABLED,
			LocationModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Location> findByLocationId(long locationId, int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public Location findByLocationId_First(long locationId,
		OrderByComparator orderByComparator)
		throws NoSuchLocationException, SystemException {
		Location location = fetchByLocationId_First(locationId,
				orderByComparator);
	 ...
	 */
	@Override
	public Location fetchByLocationId_First(long locationId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Location> list = findByLocationId(locationId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Location findByLocationId_Last(long locationId,
		OrderByComparator orderByComparator)
		throws NoSuchLocationException, SystemException {
		Location location = fetchByLocationId_Last(locationId, orderByComparator);
	 ...
	 */
	@Override
	public Location fetchByLocationId_Last(long locationId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Location> list = findByLocationId(locationId, count - 1, count,
				orderByComparator);
	...
	public void removeByLocationId(long locationId) throws SystemException {
		for (Location location : findByLocationId(locationId,
	...
	private static final String _FINDER_COLUMN_LOCATIONID_LOCATIONID_2 = "location.locationId = ?";
	...
	@Override
	public Location updateImpl(com.ocms.course.model.Location location)
		throws SystemException {
		location = toUnwrappedModel(location);
		...
		if (isNew || !LocationModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((locationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						locationModelImpl.getOriginalLocationId()
					};
				...
				args = new Object[] { locationModelImpl.getLocationId() };
	...
	protected Location toUnwrappedModel(Location location) {
		...
		locationImpl.setAddressLine1(location.getAddressLine1());
		locationImpl.setAddressLine2(location.getAddressLine2());
		locationImpl.setCity(location.getCity());
		locationImpl.setState(location.getState());
		locationImpl.setCountry(location.getCountry());
		locationImpl.setRegion(location.getRegion());
		locationImpl.setZipcode(location.getZipcode());
		locationImpl.setPhone(location.getPhone());
		locationImpl.setFax(location.getFax());
		locationImpl.setEmail(location.getEmail());
		locationImpl.setSiteUrl(location.getSiteUrl());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.ocms.course.model.Location")));
