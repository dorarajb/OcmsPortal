...
import com.ocms.course.NoSuchEventException;
import com.ocms.course.model.Event;
import com.ocms.course.model.impl.EventImpl;
import com.ocms.course.model.impl.EventModelImpl;
...
public class EventPersistenceImpl extends BasePersistenceImpl<Event>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_EVENTID = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, EventImpl.class,
	 ...
	 */
	@Override
	public List<Event> findByEventId(long eventId) throws SystemException {
	 ...
	 */
	@Override
	public Event findByEventId_First(long eventId,
	 ...
	 */
	@Override
	public Event fetchByEventId_First(long eventId,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public Event findByEventId_Last(long eventId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
	 ...
	 */
	@Override
	public Event fetchByEventId_Last(long eventId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Event> list = findByEventId(eventId, count - 1, count,
				orderByComparator);
	...
	public void removeByEventId(long eventId) throws SystemException {
		for (Event event : findByEventId(eventId, QueryUtil.ALL_POS,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_FLAG = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, EventImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByFlag",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_FLAG = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, EventImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByFlag",
			new String[] { Integer.class.getName() },
			EventModelImpl.FLAG_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_FLAG = new FinderPath(EventModelImpl.ENTITY_CACHE_ENABLED,
			EventModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByFlag",
			new String[] { Integer.class.getName() });
	 ...
	 */
	@Override
	public List<Event> findByFlag(int flag) throws SystemException {
		return findByFlag(flag, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Event> findByFlag(int flag, int start, int end)
		throws SystemException {
		return findByFlag(flag, start, end, null);
	}
	...
	public List<Event> findByFlag(int flag, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_FLAG;
			finderArgs = new Object[] { flag };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_FLAG;
			finderArgs = new Object[] { flag, start, end, orderByComparator };
		}
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_FLAG_FLAG_2);
	 ...
	 */
	@Override
	public Event findByFlag_First(int flag, OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		Event event = fetchByFlag_First(flag, orderByComparator);
	 ...
	 */
	@Override
	public Event fetchByFlag_First(int flag, OrderByComparator orderByComparator)
		throws SystemException {
		List<Event> list = findByFlag(flag, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Event findByFlag_Last(int flag, OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		Event event = fetchByFlag_Last(flag, orderByComparator);
	 ...
	 */
	@Override
	public Event fetchByFlag_Last(int flag, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByFlag(flag);

		if (count == 0) {
			return null;
		}

		List<Event> list = findByFlag(flag, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public Event[] findByFlag_PrevAndNext(long eventId, int flag,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		Event event = findByPrimaryKey(eventId);
		...
		try {
			...
			array[0] = getByFlag_PrevAndNext(session, event, flag,
					orderByComparator, true);

			array[1] = event;

			array[2] = getByFlag_PrevAndNext(session, event, flag,
					orderByComparator, false);
	...
	protected Event getByFlag_PrevAndNext(Session session, Event event,
		int flag, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByFlag(int flag) throws SystemException {
		for (Event event : findByFlag(flag, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(event);
		}
	}
	 ...
	 */
	@Override
	public int countByFlag(int flag) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_FLAG;

		Object[] finderArgs = new Object[] { flag };
	...
	@Override
	public Event updateImpl(com.ocms.course.model.Event event)
		throws SystemException {
		event = toUnwrappedModel(event);
		...
		if (isNew || !EventModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((eventModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { eventModelImpl.getOriginalEventId() };
			...
			if ((eventModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_FLAG.getColumnBitmask()) != 0) {
				Object[] args = new Object[] { eventModelImpl.getOriginalFlag() };
				...
				args = new Object[] { eventModelImpl.getFlag() };
	...
	protected Event toUnwrappedModel(Event event) {
		...
		eventImpl.setCourseCode(event.getCourseCode());
		eventImpl.setLocationCode(event.getLocationCode());
		...
		eventImpl.setFlag(event.getFlag());
		eventImpl.setCourseId(event.getCourseId());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.ocms.course.model.Event")));
