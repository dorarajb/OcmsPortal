...
import com.ocms.course.service.TaxTypesLocalService;
...
/**
 * Provides the base implementation for the tax types local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.ocms.course.service.impl.TaxTypesLocalServiceImpl}.
 * </p>
 *
 * @author doraraj
 ...
 * @generated
 */
public abstract class TaxTypesLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements TaxTypesLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.ocms.course.service.TaxTypesLocalServiceUtil} to access the tax types local service.
	 */
	...
	@Override
	public TaxTypes addTaxTypes(TaxTypes taxTypes) throws SystemException {
		taxTypes.setNew(true);

		return taxTypesPersistence.update(taxTypes);
	}
	 ...
	 */
	@Override
	public TaxTypes createTaxTypes(long taxTypesId) {
		return taxTypesPersistence.create(taxTypesId);
	}
	...
	@Override
	public TaxTypes deleteTaxTypes(long taxTypesId)
		throws PortalException, SystemException {
		return taxTypesPersistence.remove(taxTypesId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TaxTypes deleteTaxTypes(TaxTypes taxTypes) throws SystemException {
		return taxTypesPersistence.remove(taxTypes);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TaxTypes.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return taxTypesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return taxTypesPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return taxTypesPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return taxTypesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TaxTypes fetchTaxTypes(long taxTypesId) throws SystemException {
		return taxTypesPersistence.fetchByPrimaryKey(taxTypesId);
	}
	 ...
	 */
	@Override
	public TaxTypes getTaxTypes(long taxTypesId)
		throws PortalException, SystemException {
		return taxTypesPersistence.findByPrimaryKey(taxTypesId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return taxTypesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TaxTypes> getTaxTypeses(int start, int end)
		throws SystemException {
		return taxTypesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTaxTypesesCount() throws SystemException {
		return taxTypesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TaxTypes updateTaxTypes(TaxTypes taxTypes) throws SystemException {
		return taxTypesPersistence.update(taxTypes);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.ocms.course.model.TaxTypes",
			taxTypesLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.ocms.course.model.TaxTypes");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = taxTypesPersistence.getDataSource();
	...
	private TaxTypesLocalServiceClpInvoker _clpInvoker = new TaxTypesLocalServiceClpInvoker();
}