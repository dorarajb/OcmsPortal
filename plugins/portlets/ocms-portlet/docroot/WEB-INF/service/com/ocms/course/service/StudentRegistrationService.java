...
/**
 * Provides the remote service interface for StudentRegistration. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author doraraj
 * @see StudentRegistrationServiceUtil
...
public interface StudentRegistrationService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StudentRegistrationServiceUtil} to access the student registration remote service. Add custom service methods to {@link com.ocms.course.service.impl.StudentRegistrationServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
