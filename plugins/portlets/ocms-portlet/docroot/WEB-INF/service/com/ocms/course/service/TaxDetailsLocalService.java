...
/**
 * Provides the local service interface for TaxDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author doraraj
 * @see TaxDetailsLocalServiceUtil
...
public interface TaxDetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaxDetailsLocalServiceUtil} to access the tax details local service. Add custom service methods to {@link com.ocms.course.service.impl.TaxDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
