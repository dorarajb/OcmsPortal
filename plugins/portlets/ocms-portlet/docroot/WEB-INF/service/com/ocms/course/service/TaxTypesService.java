...
/**
 * Provides the remote service interface for TaxTypes. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author doraraj
 * @see TaxTypesServiceUtil
...
public interface TaxTypesService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TaxTypesServiceUtil} to access the tax types remote service. Add custom service methods to {@link com.ocms.course.service.impl.TaxTypesServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
