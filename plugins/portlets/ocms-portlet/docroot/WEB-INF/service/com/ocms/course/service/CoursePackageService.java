...
/**
 * Provides the remote service interface for CoursePackage. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author doraraj
 * @see CoursePackageServiceUtil
...
public interface CoursePackageService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CoursePackageServiceUtil} to access the course package remote service. Add custom service methods to {@link com.ocms.course.service.impl.CoursePackageServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
